...
public class Neo4jTest {
    ...
    public void ConnectTest(){
        ...
        boolean open = neo4jUtil.isNeo4jOpen();

    }
    @Test
    public void RunCypherTest(){

        String cypher = "CREATE (TheMatrix:Movie {title:'The Matrix', released:1999, tagline:'Welcome to the Real World'})\n" +
                ...
                ";" ;
        String cypher1 = "MATCH (tom:Person {name:\"Tom Hanks\"})-[:ACTED_IN]->(m)<-[:ACTED_IN]-(coActors) RETURN coActors";
        Neo4jUtil.runCypherSql(cypher1);
    }
    @Test
...
//        }
    ...
    public void WordExportTest() throws IOException {
        ...
        String templatePath = "templates/Wordtemplate/user.docx";
