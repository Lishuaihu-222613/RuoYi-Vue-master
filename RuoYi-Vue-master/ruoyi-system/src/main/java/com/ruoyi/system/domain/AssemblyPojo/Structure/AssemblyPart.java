...
public class AssemblyPart extends AssemblyStructure{
    ...
    public AssemblyPart(Long structureId, Set<AssemblyComponent> components, Set<AssemblyPart> parts, Set<AssemblyConstraint> constraints, Location location, AdvancedBerpShape geometry, Integer partQuantity, String partName, String partDescription, String partSource, double partDensity, double partWetArea, double partVolume, double partMass, String partBoundingBox) {
