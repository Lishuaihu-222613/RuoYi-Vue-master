...
import com.ruoyi.system.domain.KgBuilderPojo.domain.ComponentContainer;
import com.ruoyi.system.domain.KgBuilderPojo.domain.DataLink;
import com.ruoyi.system.domain.KgBuilderPojo.domain.DataNode;
...
import com.ruoyi.system.service.KgBuilderService.*;
...
public class WorkFlowDirectorServiceImpl implements IWorkFlowDirectorService {
    ...
    public void direct(int domainId) {
        ...
        try {
            KgDomain kgDomain = (KgDomain) kgService.selectById(domainId);
            if (kgDomain == null) {
