      ...
      <el-col :span="20" :xs="24">
        ...
        >
          ...
          <el-table-column v-if="columns[4].visible" key="equipmentPower" :show-overflow-tooltip="true"
                           align="center"
                           label="设备功率" prop="equipmentPower"
          />
          <el-table-column v-if="columns[5].visible" key="equipmentPrice" :show-overflow-tooltip="true"
                           align="center"
                           label="设备价格" prop="equipmentPrice"
          />
          <el-table-column v-if="columns[6].visible" key="productionDate" :show-overflow-tooltip="true"
                           align="center"
          ...
          />
          <el-table-column v-if="columns[8].visible" key="equipmentSize" :show-overflow-tooltip="true"
                           align="center"
                           label="设备型号" prop="equipmentSize"
          />
          <el-table-column v-if="columns[9].visible" key="equipmentState" :show-overflow-tooltip="true"
                           align="center"
          ...
          <el-table-column v-if="columns[10].visible" key="depreciationRate" :show-overflow-tooltip="true"
                           align="center"
                           label="折旧率" prop="depreciationRate"
          />
          <el-table-column v-if="columns[11].visible" key="loadRate" :show-overflow-tooltip="true"
                           align="center"
                           label="负载率" prop="loadRate"
          />
          <el-table-column v-if="columns[12].visible" key="principle" :show-overflow-tooltip="true"
                           align="center"
                           label="使用原则" prop="principle"
          />
          <el-table-column v-if="columns[13].visible" key="equipmentCapacity" :show-overflow-tooltip="true"
                           align="center"
                           label="设备能力" prop="equipmentCapacity"
          >
            <template slot-scope="scope">
    ...
    <el-dialog :title="title" :visible.sync="modifyResourceShow" width="600px" append-to-body>
      <el-form ref="resource" :model="selectResource" :rules="rules" label-width="80px">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="使用原则" prop="principle">
              <el-input v-model="selectResource.principle" placeholder="请输入使用原则"  />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="设备功率" prop="equipmentPower">
              <el-input v-model="selectResource.equipmentPower" placeholder="请输入设备功率"  />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="设备价格" prop="equipmentPrice">
              <el-input v-model="selectResource.equipmentPrice" placeholder="请输入设备价格"  />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="生产日期" prop="productionDate">
              <el-date-picker
                v-model="selectResource.productionDate"
                type="date"
                placeholder="选择日期"
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="设备型号" prop="equipmentSize">
              <el-input v-model="selectResource.equipmentSize" placeholder="请输入设备功率"  />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="设备状态" prop="equipmentState">
              <el-switch
                v-model="selectResource.equipmentState"
                active-color="#13ce66"
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="折旧率" prop="depreciationRate">
              <el-input-number v-model="selectResource.depreciationRate" :precision="2" placeholder="请输入折旧率"  />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="负载率" prop="loadRate">
              <el-input-number v-model="selectResource.loadRate" :precision="2" placeholder="请输入设备价格"  />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
            ...
            <el-row v-for="(item,index) in selectResource.attentions" :key="index">
              ...
              <el-col :span="4">
                <el-button
                  ...
                  @click="removeAttention(selectResource.attentions[index])"
                ></el-button>
              </el-col>
            </el-row>
          </el-form-item>
  ...
  data() {
    return {
      ...
      upload: {
        ...
        // 上传的地址
        url: process.env.VUE_APP_BASE_API + '/EquipmentResource/importData'
      },
      queryParams: {
        pageNum: 1,
        pageSize: 9,
      ...
      columns: [
        ...
        { key: 4, label: `设备功率`, visible: true },
        { key: 5, label: `设备价格`, visible: true },
        { key: 6, label: `生产日期`, visible: true },
        { key: 7, label: `制造商`, visible: true },
        { key: 8, label: `设备型号`, visible: true },
        { key: 9, label: `设备状态`, visible: true },
        { key: 10, label: `折旧率`, visible: true },
        { key: 11, label: `负载率`, visible: true },
        { key: 12, label: `使用原则`, visible: true },
        { key: 13, label: `设备能力`, visible: true },
        { key: 14, label: `注意事项`, visible: true }
      ],
      title: '',
  ...
  methods: {
    ...
    getList() {
      ...
      if (this.queryParams.dynamicLabel === '') {
        resourceManagement.getAllEquipmentResources(this.queryParams).then(result => {
            if (result.code === 200) {
