  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="modifyResourceShow" width="600px" append-to-body>
      <el-form ref="resource" :model="selectResource" :rules="rules" label-width="80px">
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="最大载荷" prop="maximumLoad">
              <el-input v-model="selectResource.maximumLoad" placeholder="请输入最大载荷"  />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
...
export default {
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { key: 12, label: `最大载荷`, visible: true },
  ...
  methods: {
    ...
    /** 查询知识下拉树结构 */
    getTreeselect() {
      treeManagement.getTreeManagement(25821).then(response => {
      ...
      this.$refs["resource"].validate(valid => {
        if (valid) {
          if (this.selectResource.resourceId !== undefined) {
            ...
            resourceManagement.createSpreaderTool(this.selectResource).then(response => {
